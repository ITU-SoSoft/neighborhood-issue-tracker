          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="rounded-xl border border-dashed border-border bg-muted/40 p-8 text-center text-sm text-muted-foreground">
                A map-based visualization of issue density by neighborhood will
                be displayed here. Support staff can use this view to identify
                hotspots and prioritize field teams.
              </div>
              ...
              <div className="grid gap-4 text-xs text-muted-foreground md:grid-cols-3">
                ...
                <div>
                  ...
                  <p>
                    This view will later be connected to the analytics service
                    and map component to render real-time ticket density.
                  </p>
                </div>
              </div>
            </CardContent>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        variants={fadeInUp}
      >
        {/* ✅ Workload Snapshot (dynamic teams) */}
        <Card>
          <CardContent className="p-6">
            ...
            {teamsQuery.isLoading ? (
              ...
              (() => {
                const totalOpen = teams.reduce(
                  (sum, t) => sum + (t.active_ticket_count ?? 0),
                  0,
                );
                ...
                return (
                  <div className="space-y-3 text-xs text-muted-foreground">
                    {topTeams.map((t) => {
                      const open = t.active_ticket_count ?? 0;
                      const percent =
                        totalOpen > 0
                          ? Math.round((open / totalOpen) * 100)
                          : 0;
                    ...
                    {totalOpen === 0 && (
                      <p className="pt-2 text-sm text-muted-foreground">
                        No open tickets assigned to teams yet.
                      </p>
                    )}
                  </div>
                );
